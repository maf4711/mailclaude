...
| | |
|---|---|
| GitHub | `maf4711/mailclaude` |
| SSH | `git@github.com:maf4711/mailclaude.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/mailclaude.git` |
| Ordner | `~/Developer/mailclaude` |
| Default-Branch | `main` |
...
3. Dieser Checkout liegt danach unter `~/Developer/mailclaude`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
